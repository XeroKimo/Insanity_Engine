...
//		TypedD3D::Wrapper<ID3D11Buffer> instanceBuffer;
//		TypedD3D::Wrapper<ID3D11RasterizerState> rasterizerState;
//
//		TypedD3D::Wrapper<ID3D11InputLayout> layout;
//		TypedD3D::Wrapper<ID3D11VertexShader> vertexShader;
//		TypedD3D::Wrapper<ID3D11PixelShader> pixelShader;
//		TypedD3D::Wrapper<ID3D11ShaderResourceView> defaultTexture;
//		TypedD3D::Wrapper<ID3D11DepthStencilState> depthState;
//		TypedD3D::Wrapper<ID3D11SamplerState> pointSampler;
//		TypedD3D::Wrapper<ID3D11BlendState> blendState;
//
//	public:
...
//		void SetTexture(TypedD3D::Wrapper<ID3D11ShaderResourceView> texture);
//		void SetPriority(int priority);
//
//		TypedD3D::Wrapper<ID3D11ShaderResourceView> GetTexture() const;
//	};
//
...
//		void SetTexture(TypedD3D::Wrapper<ID3D11ShaderResourceView> texture) { handle.SetTexture(texture); }
//		void SetPriority(int priority) { handle.SetPriority(priority); }
//
//		TypedD3D::Wrapper<ID3D11ShaderResourceView> GetTexture() const { return handle.GetTexture(); }
//	};
//
//	export UniqueSpriteHandle NewSprite(TypedD3D::Wrapper<ID3D11ShaderResourceView> texture);
//
//	struct DebugPipeline
//	{
//		TypedD3D::Wrapper<ID3D11Buffer> cameraBuffer;
//		TypedD3D::Wrapper<ID3D11Buffer> vertexBuffer;
//		TypedD3D::Wrapper<ID3D11Buffer> batchBuffer;
//		TypedD3D::Wrapper<ID3D11InputLayout> layout;
//		TypedD3D::Wrapper<ID3D11VertexShader> vertexShader;
//		TypedD3D::Wrapper<ID3D11PixelShader> pixelShader;
//
